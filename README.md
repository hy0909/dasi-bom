...
- **홈** — 내가 참여 중인 앨범 목록(내가 만든 앨범 + 링크로 합류한 앨범), 새 앨범 만들기, 기록 Tip
- **앨범 상세** — 사진 / 목소리 / 기록 / 연대표 탭, 앨범 상태(기록 중·완료)
- **사진 기록 남기기** — AI 질문 3단계, 목소리(실제 마이크 녹음) 또는 글로 답하기
- **사진 기록** — AI가 정리한 기록, 문체 선택, 원본 목소리 듣기, 수정
