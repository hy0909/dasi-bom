...
export function HomeScreen({
  ...
  return (
    <>
          ...
          <>
            ...
            >
              ...
              <div
                ...
                className="hero-turn max-w-[78%] cursor-pointer rounded-sm transition-transform duration-300 ease-out outline-none hover:scale-[1.02] focus-visible:ring-3 focus-visible:ring-canvas/50 motion-reduce:transition-none motion-reduce:hover:scale-100"
              >
                <AlbumCover
                  album={heroAlbum}
      ...
      <div className="mt-7">
        <h1 className="font-heading text-lg font-bold">기억하고 싶은 순간이 있나요?</h1>
      </div>
      ...
      >
        <CardContent className="flex items-center gap-4">
          ...
          <span className="min-w-0 flex-1">
            ...
            <small className="block text-sm text-body-mid">사진을 첨부해 보세요</small>
          </span>
